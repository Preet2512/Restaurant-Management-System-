...
<?php
  ...
  {
    $reserve_id=$_GET['res_upd'];
$status=$_POST['status'];
$sql=mysqli_query($mysqli,"update Reservation set Status='$status' where Reserve_id='$reserve_id'");
if($sql) {
    echo '<script>'; 
    echo 'alert("Status has been updated");'; 
    echo 'window.location.href = "view_reservation.php";';
    echo '</script>';
        }
        else
...
<html>
<head>
    <title>Reservation Update Page</title>
...
<!-- End vertical navbar -->
 ...
 <h2 class="display-4 text-white">Reservation Update Page</h2>
  <p class="lead text-white mb-0">Manage your reservations here.</p>
        ...
        <div class="box">
            <div class="box-body">
                ...
                <header class="title text-center">
                    <p><strong>UPDATE RESERVATION STATUS</strong></p>
                </header>
                <form method="POST" class="main-form text-center">
 
 <table  border="0" cellspacing="0" cellpadding="0">
     <tr >
      <td><strong>Reservation ID&emsp;</strong></td>
      <td><b><?php echo htmlentities($_GET['res_upd']); ?></b></td>
    </tr>
	<tr>
      <td  >&nbsp;</td>
    ...
    <tr >
      ...
      <option value="arrived">Customer has arrived</option>
      <option value="paid">Customer has paid</option>
      <option value="cancel">Customer did not arrive</option>
