...
<!-- End vertical navbar -->
 ...
 <h2 class="display-4 text-white">Your Customers' reviews</h2>
  <p class="lead text-white mb-0">Take their words as motivation to work hard!</p>
  ...
  <div class="row text-white">
   ...
   echo "<thread>";
   echo "<tr>";
   echo "<th>Review ID</th><th>Customer Name</th><th>Review</th>";
   echo "</tr>";
   echo "</thread>";
   echo "<tbody>";
   while($row=$sql->fetch_assoc()) {
       echo "<tr>";
       echo "<td>".$row['Review_ID']."</td><td>".$row['Name']."</td><td>".$row['Review']."</td>";
       echo "</tr>";
   }
   echo "</tbody>";
   echo "</table>";
