...
<?php
  ...
  {
    $food_id=$_GET['food_upd'];
$avail=$_POST['availability'];
$feat=$_POST['features'];
if(!empty($avail) && empty($feat)){
  $sql1=mysqli_query($mysqli,"update Food set Available='$avail' where Food_ID='$food_id'");
}
if(!empty($feat) && empty($avail)) {
  $sql2=mysqli_query($mysqli,"update Food set Features='$feat' where Food_ID='$food_id'");
}
if($sql1 || $sql2) {
    echo '<script>'; 
...
<!-- End vertical navbar -->
 ...
 <h2 class="display-4 text-white">Food Update Page</h2>
  <p class="lead text-white mb-0">Update availability here. You can also update the best seller feature here.</p>
        ...
        <div class="box">
            <div class="box-body">
                ...
                <header class="title text-center">
                    <p><strong>UPDATE FOOD STATUS</strong></p>
                </header>
                <form method="POST" class="main-form text-center">
 
 <table  border="0" cellspacing="0" cellpadding="0">
     <tr >
      <td><strong>Food Number&emsp;</strong></td>
      <td><b><?php echo htmlentities($_GET['food_upd']); ?></b></td>
    </tr>
	<tr>
      <td  >&nbsp;</td>
    ...
    <tr >
      ...
      <option value="On">Best Seller</option>
    <option value="Off">Not Best Seller</option>
