...
<?php
  ...
  {
    $order_id=$_GET['order_upd'];
$status=$_POST['status'];
$sql=mysqli_query($mysqli,"update Orders set Status='$status' where Order_ID='$order_id'");
if($sql) {
    echo '<script>'; 
...
<!-- End vertical navbar -->
 ...
 <h2 class="display-4 text-white">Order Update Page</h2>
  <p class="lead text-white mb-0">Manage your orders here.</p>
...
<div class="container">
 ...
 <table  border="0" cellspacing="0" cellpadding="0">
     <tr >
      <td><strong>Order Number&emsp;</strong></td>
      <td><b><?php echo htmlentities($_GET['order_upd']); ?></b></td>
    </tr>
	<tr>
      <td  >&nbsp;</td>
