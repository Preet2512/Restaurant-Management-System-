...
<?php
  ...
  {
    $take_id=$_GET['take_upd'];
$status=$_POST['status'];
$sql=mysqli_query($mysqli,"update Takeaway set Status='$status' where Takeaway_id='$take_id'");
if($sql) {
    echo '<script>'; 
    echo 'alert("Status has been updated");'; 
    echo 'window.location.href = "view_takeaway.php";';
    echo '</script>';
        }
        else
...
<html>
<head>
    <title>Takeaway Update Page</title>
...
<!-- End vertical navbar -->
 ...
 <h2 class="display-4 text-white">Takeaway Update Page</h2>
  <p class="lead text-white mb-0">Manage your takeaways here.</p>
        ...
        <div class="box">
            <div class="box-body">
                ...
                <header class="title text-center">
                    <p><strong>UPDATE TAKEAWAY STATUS</strong></p>
                </header>
                <form method="POST" class="main-form text-center">
 
 <table  border="0" cellspacing="0" cellpadding="0">
     <tr >
      <td><strong>Takeaway ID&emsp;</strong></td>
      <td><b><?php echo htmlentities($_GET['take_upd']); ?></b></td>
    </tr>
	<tr>
      <td  >&nbsp;</td>
    ...
    <tr >
      ...
      <option value="paid">Order Taken</option>
      </select></td>
    </tr>
    <tr>
      <td  >&nbsp;</td>
