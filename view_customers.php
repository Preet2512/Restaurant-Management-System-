...
<!-- End vertical navbar -->
 ...
 <h2 class="display-4 text-white">Your Customers</h2>
  <p class="lead text-white mb-0">Wow!! So many customers!! Your restaurants are famous now!!</p>
  ...
  <div class="row text-white">
   ...
   echo "<thread>";
   echo "<tr>";
   echo "<th>Customer Name</th><th>Phone Number</th><th>Address</th>";
   echo "</tr>";
   echo "</thread>";
   echo "<tbody>";
   while($row=$sql->fetch_assoc()) {
       echo "<tr>";
       echo "<td>".$row['Name']."</td><td>".$row['Phone']."</td><td>".$row['Address']."</td>";
       echo "</tr>";
   }
   echo "</tbody>";
   echo "</table>";
